...
const techs = [
  ...
  { icon: <SiNextdotjs size={20} />,         label: "Next.js",       color: "#ffffff" },
  { icon: <SiTailwindcss size={20} />,       label: "Tailwind CSS",  color: "#38bdf8" },
  { icon: <SiFramer size={20} />,            label: "Framer Motion", color: "#0055ff" },
  { icon: <TbBrandThreejs size={20} />,      label: "Three.js",      color: "#ffffff" },
  { icon: <SiExpress size={20} />,           label: "Express",       color: "#ffffff" },
  ...
  { icon: <SiVercel size={20} />,            label: "Vercel",        color: "#ffffff" },
    ...
    >
      ...
      <div style={{ maxWidth: "1240px", margin: "0 auto 64px", padding: "0 24px" }}>
        ...
        >
          ...
          >
            My <span style={{ fontWeight: 900, color: "#fff" }}>Arsenal</span>
          </h2>
        </motion.div>
      </div>
